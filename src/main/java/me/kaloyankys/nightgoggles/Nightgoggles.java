...
public class Nightgoggles implements ModInitializer {
    public static final Item NIGHT_GOGGLES = new NightGoggles(ArmorMaterials.CHAIN, EquipmentSlot.HEAD, new FabricItemSettings().group(ItemGroup.TOOLS).maxCount(1));
